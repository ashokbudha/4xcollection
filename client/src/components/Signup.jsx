    ...
    >
      ...
      >
        ...
        <div className="mb-6 text-center">
          ...
          <h1 id="signup-title" className="text-3xl font-semibold text-white">Create your account</h1>
          <p className="mt-2 text-sm text-slate-300">Join 4X Collection and save the pieces you love.</p>
        </div>

        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            <label htmlFor="signup-name" className="mb-1 block text-sm font-medium text-slate-200">Full name</label>
            <input
              id="signup-name"
              name="name"
              type="text"
          ...
          <div>
            <label htmlFor="signup-email" className="mb-1 block text-sm font-medium text-slate-200">Email</label>
            <input
              id="signup-email"
              name="email"
              type="email"
          ...
          <div>
            <label htmlFor="signup-password" className="mb-1 block text-sm font-medium text-slate-200">Password</label>
            <input
              id="signup-password"
              name="password"
              type="password"
          ...
          <label className="flex items-start gap-2 text-sm text-slate-300">
            <input type="checkbox" required className="mt-0.5 h-4 w-4 rounded border-slate-600 bg-slate-900 text-cyan-500 focus:ring-cyan-400" />
        ...
        <p className="mt-6 text-center text-sm text-slate-300">
          ...
          <button type="button" onClick={onShowLogin} className="font-medium text-cyan-400 hover:text-cyan-300">
            Log in
          </button>
        </p>
      </section>
